...
-- Recréer la table sellers avec des contraintes plus souples
...
comment on column public.sellers.first_name is 'Prénom du vendeur (optionnel)';
comment on column public.sellers.last_name is 'Nom du vendeur (optionnel)';
comment on column public.sellers.phone is 'Numéro de téléphone (optionnel)';
